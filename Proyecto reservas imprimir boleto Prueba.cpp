			...
			case 3:{
			    system("cls");
			   	...
			   	if(boleto== NULL){
				   	...
				   	fprintf(boleto, "_____________BOLETO DE VUELO._______________________\n");
				   	fprintf(boleto, "|Asiento reservado en la fila %d y en la columna %d\n",(fila+1), (columna+1));
				   	fprintf(boleto, "|Usuario %s %s\n",persona.nombre, persona.apellido);
				   	fprintf(boleto, "|Numero de identificacion: %s\n",persona.identificacion);
				   	fprintf(boleto, "|Numero de celular: %s\n",persona.numero);
				}
				printf("Su boleto se creado exitosamente!!\n");
				   fflush(boleto);
				   fclose(boleto);
